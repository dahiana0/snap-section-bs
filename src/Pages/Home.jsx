                    ...
                    <div className="col-6 ">
                        ...
                        <div className="d-flex flex-column justitify-content-center h-100 gap-5">
                            ...
                            <div className="d-flex gap-3 aling-items-center">
                                <img src="public/logo 3.svg" height="25" alt="" />
                                <img src="public/mux-logo.png" height="25" alt="" />
                                <img src="public/wiz.svg" height="25" alt="" />
                                <img src="public/zephyr_cloud.png"height="25" alt="" />
                            </div>
                        </div>
                    </div>
